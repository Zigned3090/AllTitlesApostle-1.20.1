...
public abstract class ATAUniform extends Uniform implements UniformHelper {
    ...
    protected ATAUniform(String name, UniformType type, int count, @Nullable Shader parent) {
    ...
    public static ATAUniform makeUniform(String name, UniformType type, int count, @Nullable Shader parent) {
        if (count % type.getSize() != 0) {
            ...
            switch (type.getCarrier()) {
                case INT:
                case U_INT:
                    var10000 = new ATAUniform.IntUniform(name, type, count, parent);
                    break;
                case FLOAT:
                case MATRIX:
                    var10000 = new ATAUniform.FloatUniform(name, type, count, parent);
                    break;
                case DOUBLE:
                case D_MATRIX:
                    var10000 = new ATAUniform.DoubleUniform(name, type, count, parent);
                    break;
                default:
                    throw new IncompatibleClassChangeError();
            }

            return (ATAUniform) var10000;
        }
    }
    ...
    private static class IntUniform extends ATAUniform.UniformEntry<int[]> {
    ...
    private static class FloatUniform extends ATAUniform.UniformEntry<float[]> {
    ...
    private static class DoubleUniform extends ATAUniform.UniformEntry<double[]> {
    ...
    private abstract static class UniformEntry<T> extends ATAUniform {
